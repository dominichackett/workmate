...
interface NotificationProps {
  show: boolean; // Determines if the notification is visible
  type: number; // Notification type: 1 (success), 2 (error), 3 (info)
  title: string; // Title of the notification
  description: string; // Description of the notification
  close: () => void; // Function to close the notification
}
