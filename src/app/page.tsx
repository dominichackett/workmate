...
Work Mate. <br/>Your AI Freelancer Job  <br/> Search Assistant
</h1><p className="text-lg mt-4 text-slate-600 max-w-xl" >
an AI-powered agent designed to automate the process of finding freelance jobs on Freelancer.com. It fetches job listings based on your search parameters, filters them using criteria like keywords, budget, and client history, and drafts personalized proposals for you to respond to.</p>
